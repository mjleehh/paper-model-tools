...
class Mesh:
    def __init__(self, objMesh: MeshImpl):
...
class MeshFace:
    def __init__(self, objMesh: MeshImpl, index):
        self._objMesh = objMesh
        self.index = index
    ...
    def getConnectedFaces(self):
        ...
        return [MeshFace(self._objMesh, faceIndex)
                ...
                for faceIndex in MeshEdge(edge, self._objMesh).faces
                if faceIndex != self.index]
...
class MeshFaceEdges:
    def __init__(self, faceIndex, objMesh: MeshImpl):
        self._objMesh = objMesh
...
class MeshEdge:
    def __init__(self, index, objMesh: MeshImpl, flipped=False):
        self._objMesh = objMesh
        self.index = index
    ...
    @property
    def faces(self):
        return [faceIndex for faceIndex, face in enumerate(self._objMesh.faces)
            if self.index in face.edges]
